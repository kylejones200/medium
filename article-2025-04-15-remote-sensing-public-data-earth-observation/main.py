...
from src.core import simulate_satellite_data, analyze_earth_observation, calculate_ndvi, plot_earth_observation
...
def main():
    ...
    if args.data_path and args.data_path.exists():
        ...
        print("Simulating satellite remote sensing data...")
    ...
    print("Analyzing earth observation data...")
    ...
    print(f"Number of bands: {analysis['n_bands']}")
