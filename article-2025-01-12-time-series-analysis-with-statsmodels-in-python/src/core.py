...
def plot_time_series(
    ...
    apply_tufte_style(ax, title="Time Series: Full Dataset and Hold-Out Period")
    ax.set_xlabel("Date")
    ax.set_ylabel("Value")
    ax.legend(loc='best')
...
def plot_arima_forecast(
    ...
    apply_tufte_style(ax, title=f"ARIMA Forecast: MAPE = {mape:.2%}")
    ax.set_xlabel("Date")
    ax.set_ylabel("Value")
    ax.legend(loc='best')
...
def plot_holt_winters_forecast(
    ...
    apply_tufte_style(ax, title=f"Holt-Winters Exponential Smoothing: MAPE = {mape:.2%}")
    ax.set_xlabel("Date")
    ax.set_ylabel("Value")
    ax.legend(loc='best')
