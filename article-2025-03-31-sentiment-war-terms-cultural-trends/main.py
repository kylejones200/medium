...
from src.core import calculate_sentiment_score, plot_sentiment_trend, plot_word_frequency
...
def main():
    ...
    print(f"Mean sentiment: {sentiment.mean():.4f}")
    print(f"Sentiment range: [{sentiment.min():.4f}, {sentiment.max():.4f}]")
