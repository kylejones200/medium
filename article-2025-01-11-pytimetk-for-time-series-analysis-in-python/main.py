...
from src.core import prepare_time_series_data, analyze_time_series_features, plot_pytimetk_analysis
...
def main():
    ...
    print("Note: PyTimeTK provides time series manipulation and analysis tools")
    print("Example usage:")
    print("  import pytimetk as tk")
    print("  df.summarize_by_time()")
    print("  df.pad_by_time()")
